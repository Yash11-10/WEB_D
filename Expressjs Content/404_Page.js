...
app.use(express.static(publicPath)) //ye static esmei check kregi ki koi bhi static file y link hai to usko sbse phle public k path dena hai or uske baad aage k mei add krdena hai or uske baad file load ho jygi.ye css file k liye hai edhr
